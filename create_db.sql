...
CREATE TABLE users (id INT AUTO_INCREMENT, username VARCHAR(50) UNIQUE NOT NULL, first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(100) UNIQUE NOT NULL, hashedPassword VARCHAR(255) NOT NULL, PRIMARY KEY (id));
